...
import { User, Phone, Lock, PiggyBank, Eye, EyeOff } from 'lucide-react';
...
const Register: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    const success = await register(formData.name, formData.phone, formData.password);
    if (success) {
      navigate('/', { replace: true });
    }
    ...
    <div className="min-h-screen flex items-center justify-center py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-md w-full">
        <div className="text-center mb-8">
          ...
          <h2 className="text-3xl font-bold text-gray-900">Join Piggy Goals</h2>
          <p className="mt-2 text-gray-600">Start your savings journey today</p>
        </div>
